...
public class ChoiceImpl extends MinimalEObjectImpl.Container implements Choice
{
  ...
  {
    return MySurveyPackage.Literals.CHOICE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MySurveyPackage.CHOICE__NAME, oldName, name));
  }
  ...
  public void setText(String newText)
  {
    ...
    text = newText;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MySurveyPackage.CHOICE__TEXT, oldText, text));
  }
