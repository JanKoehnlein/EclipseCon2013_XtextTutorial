...
* generated by Xtext
*/
package org.eclipse.xtext.tutorial.myquestionnaire.services;
...
@Singleton
public class MyQuestionnaireGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class QuestionnaireElements extends AbstractParserRuleElementFinder {
		...
		//Questionnaire:
		//	"questionnaire" name=ID title=STRING pages+=Page*;
	...
	@Inject
	public MyQuestionnaireGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.xtext.tutorial.myquestionnaire.MyQuestionnaire".equals(grammar.getName())) {
				return grammar;
			}
