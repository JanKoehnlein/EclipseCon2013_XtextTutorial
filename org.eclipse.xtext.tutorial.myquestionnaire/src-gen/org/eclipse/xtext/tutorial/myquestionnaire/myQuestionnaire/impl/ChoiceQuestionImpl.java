 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.tutorial.myquestionnaire.myQuestionnaire.impl.ChoiceQuestionImpl#isSingle <em>Single</em>}</li>
 *   <li>{@link org.eclipse.xtext.tutorial.myquestionnaire.myQuestionnaire.impl.ChoiceQuestionImpl#getChoices <em>Choices</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceQuestionImpl extends QuestionImpl implements ChoiceQuestion
{
  ...
  {
    return MyQuestionnairePackage.Literals.CHOICE_QUESTION;
  }
  ...
  public void setSingle(boolean newSingle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyQuestionnairePackage.CHOICE_QUESTION__SINGLE, oldSingle, single));
  }
  ...
  public EList<Choice> getChoices()
  {
    if (choices == null)
    {
      choices = new EObjectContainmentEList<Choice>(Choice.class, this, MyQuestionnairePackage.CHOICE_QUESTION__CHOICES);
    }
    return choices;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyQuestionnairePackage.CHOICE_QUESTION__CHOICES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyQuestionnairePackage.CHOICE_QUESTION__SINGLE:
        return isSingle();
      case MyQuestionnairePackage.CHOICE_QUESTION__CHOICES:
        return getChoices();
    }
